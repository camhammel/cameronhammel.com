<svg viewBox="1.2 .4 352.2 70.9" xmlns="http://www.w3.org/2000/svg"
	><path d="m264 25.5v44.7h-14.4v-51.7z" fill="currentColor" fill-opacity=".5" /><path
	...
	/><path
		...
		fill="currentColor"
	/><path d="m328.5 44.1v26.1h-14.2v-26.1" fill="currentColor" fill-opacity=".25" /><path
		d="m338.3 1.5-24 42.6h14.2l24.9-42.6z"
		fill="currentColor"
	/><path d="m314.3 44.1-24.8-42.6h15.6l16.7 29.2z" fill="currentColor" fill-opacity=".5" /><path
	...
	/><g fill="currentColor" fill-opacity=".5"
		><path d="m179 44.9v-43.4h13.8v68.7h-13.8z" /><path
